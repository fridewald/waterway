...
// build/dev/javascript/water_way/water_way.mjs
function main() {
  let app = element2(
    div(
      toList([
      ...
      toList([
        h1(
          toList([class$("text-xl"), class$("bold")]),
          toList([text("Hello from water_way")])
        ),
        figure(
          toList([
            classes(
          ...
          toList([
            img(
              toList([
                class$("rounded-xl"),
                class$("image-center"),
                src("https://c.tenor.com/y3yHviIAcg4AAAAd/tenor.gif")
              ])
            )
          ])
        )
